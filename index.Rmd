...
- What is guided tour? 
- What are the optimisers?
- An example of optimising with tour

???

- motivation and background
- specifically, what is guided tour, what are the optimisers with an example
...
- Simulated data: 5 variables, $x_2$ is informative: $0.5 \mathcal{N}(-3, 1) + 0.5 \mathcal{N}(3, 1)$, others are random normal
- Run guided tour and record the relevant information
...
- similarly we can generate random 2D bases, animate with tour, and embed the 2D path

- Here is the 2D basis space and some frames captured from the animation
